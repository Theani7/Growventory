...
/**
 * Idempotent schema migrations. Safe to call any number of times — every
 * ALTER is wrapped in try/catch so re-runs are no-ops. Lets scripts like
 * seed/reset bootstrap a fresh database without requiring the server to boot
 * first.
 */
