        ...
        <div className="fixed inset-0 z-[100] bg-white flex items-center justify-center p-4">
          <div className="max-w-md w-full text-center">
            ...
            <p className="mt-3 text-gray-600 leading-relaxed">
              Thanks, <span className="font-semibold text-gray-900">{verifiedResult.username}</span> — your email is verified. An administrator will review your account and assign you a role shortly.
            </p>
            ...
            <p className="mt-4 text-xs text-gray-500">Need access faster? Contact your administrator directly.</p>
          </div>
        </div>
      )}
      {/* Left form */}
      <div className="flex-1 flex flex-col px-6 sm:px-12 lg:px-16 xl:px-24 py-8 relative">
        ...
        <div className="flex-1 flex flex-col justify-center max-w-md w-full mx-auto py-12">
          <div className="mb-8">
            ...
            <h1 className="text-4xl font-bold text-gray-900 tracking-tight">Check your email</h1>
          ...
          <form onSubmit={handleVerify} className="space-y-6">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500 text-center mt-3">Code expires in 10 minutes • Check spam folder</p>
            </div>
            ...
            <div className="flex items-center justify-between text-sm">
              ...
              <button
                ...
                className="inline-flex items-center gap-1.5 text-forest-700 hover:text-forest-800 font-semibold disabled:opacity-50"
              >
            ...
            <p className="text-xs text-gray-500 text-center">
              Already verified? <Link to="/login" className="text-forest-700 font-semibold hover:underline">Sign in</Link>
            </p>
          </form>
        </div>
          ...
          <div className="max-w-md">
            <div className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl p-5 shadow-2xl mb-10">
              <div className="flex items-center gap-3 mb-3">
                ...
                <div><p className="text-white font-semibold text-sm">Verify inbox</p><p className="text-forest-200 text-xs">4-digit code sent</p></div>
              </div>
              <div className="flex gap-2">
                {[...Array(4)].map((_, i) => (
                  <div key={i} className="flex-1 h-10 bg-white/90 rounded-lg flex items-center justify-center font-bold text-gray-900">{i === 1 ? '•' : i === 0 ? '•' : i === 2 ? '•' : '•'}</div>
                ))}
              </div>
            </div>
            <h2 className="text-4xl xl:text-5xl font-bold text-white leading-tight">Secure your account.</h2>
            <p className="mt-4 text-forest-100">One-time code protects your nursery data.</p>
