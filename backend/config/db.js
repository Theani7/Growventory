...
const initTables = async () => {
  ...
  await conn.execute(`CREATE TABLE IF NOT EXISTS plants (
  ...
  await conn.execute(`CREATE TABLE IF NOT EXISTS stock_movements (
  ...
  try {
    await conn.execute(`ALTER TABLE stock_movements ADD COLUMN approval_status ENUM('approved','pending','rejected') DEFAULT 'approved'`);
  } catch (e) {}
  try {
    await conn.execute(`ALTER TABLE stock_movements ADD COLUMN approved_by INT NULL`);
  } catch (e) {}
  try {
